...
//~ 		Gdk.Pixbuf? p = launcher.try_load_logos({"/usr/share/pixmaps/zlauncher.png","logo/zlauncher-256.png"});
		Gdk.Pixbuf? p = launcher.loading_content.try_load_pixbuf_from_multiple_locations({"/usr/share/pixmaps/zlauncher.png","logo/zlauncher-256.png"});
		if(p!=null){
			Gdk.Pixbuf p2 = p.scale_simple(24,24,Gdk.InterpType.BILINEAR);
			launcher.icon = p2;
			launcher.show();
